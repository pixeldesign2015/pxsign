...
This document provides a high-level overview of the PxSign codebase to help humans and agents understand how the application is structured.

## Overview

PxSign is an open-source document signing platform built as a **monorepo** using npm workspaces and Turborepo. The application enables users to create, send, and sign documents electronically.
