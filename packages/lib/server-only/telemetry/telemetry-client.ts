...
export class TelemetryClient {
  ...
  private async initialize(): Promise<void> {
    ...
    console.log(
      '[Telemetry] Telemetry is enabled. PxSign collects anonymous usage data to help improve the product.',
    );
    console.log(
    ...
    console.log(
      '[Telemetry] Learn more: https://sign.pixeldesign.io/docs/developers/self-hosting/telemetry',
    );
