...
export const ConfirmTeamEmailTemplate = ({
  ...
  baseUrl = 'https://sign.pixeldesign.io',
  teamName = 'Team Name',
  teamUrl = 'demo',
  token = '',
  ...
  const previewText = msg`Accept team email request for ${teamName} on PxSign`;
            ...
            <Section className="p-2 text-slate-500">
              ...
              <Text className="text-center text-base">
                <Trans>
                  ...
                  address for their team on PxSign.
                </Trans>
              </Text>
              ...
              <Section className="mt-6">
                ...
                <Text className="mt-2 text-sm">
                  <Trans>
                    You can revoke access at any time in your team settings on PxSign{' '}
