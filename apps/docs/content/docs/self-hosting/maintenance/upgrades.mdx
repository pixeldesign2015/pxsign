---
title: Upgrades
description: Upgrade your self-hosted PxSign installation to get the latest features, security patches, and bug fixes.
---
...
PxSign follows [Semantic Versioning](https://semver.org/):
...
Check your running PxSign version:
...
PxSign runs database migrations automatically when the container starts. No manual intervention is required.
