---
title: Backups
description: Backup strategies for PxSign data.
---
...
PxSign stores data in three locations:
...
Create a script to back up all PxSign components:
...
echo "Starting PxSign backup: $TIMESTAMP"
...
```ini
[Unit]
Description=Daily PxSign Backup
