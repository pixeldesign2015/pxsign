...
description: Diagnose and resolve common issues with your self-hosted PxSign instance, organized by component.
---
...
PxSign exposes a health endpoint to verify the application is running:
...
<Steps>
  ...
  <Step>
    Change PxSign's port mapping: `-p 3001:3000`
  </Step>
</Steps>
...
```
  ...
  <Step>
    Update the certificate file and restart PxSign
  </Step>
</Steps>
...
- **[Discord](https://documen.so/discord)**: Join the PxSign community Discord
...
For security vulnerabilities, do not open a public issue. Contact security@sign.pixeldesign.io directly.
