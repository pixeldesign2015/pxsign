---
title: Kubernetes
description: Deploy PxSign on Kubernetes for production environments requiring high availability, auto-scaling, and enterprise-grade infrastructure.
---
...
A typical PxSign Kubernetes deployment consists of:
...
Create a dedicated namespace for PxSign:
...
Update your PxSign secret to use the in-cluster database:
...
PxSign stores documents in the database by default. For high-volume deployments, configure S3-compatible storage.
...
Scale PxSign based on CPU and memory utilization:
