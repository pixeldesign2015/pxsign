...
description: Deploy PxSign with Docker Compose, including PostgreSQL. This production-ready setup is suitable for most self-hosted deployments.
---
...
The PxSign container waits for the database health check to pass before starting.
...
# Public URL where PxSign is accessible
...
For production, place PxSign behind a reverse proxy for SSL termination:
