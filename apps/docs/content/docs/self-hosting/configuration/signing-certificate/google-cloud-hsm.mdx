...
Create a service account with the `cloudkms.signerVerifier` role so PxSign can use the key.

</Step>
<Step>
### Export public certificate

Export the public certificate from the HSM key; PxSign needs it to embed in signatures.
