---
title: GDPR
description: Understand how PxSign handles GDPR compliance for data processing and storage.
---
...
When using PxSign for document signing, two distinct data processing roles apply:

| Role                | Description                                                                           |
| ------------------- | ------------------------------------------------------------------------------------- |
| **Data Controller** | You (the organisation using PxSign) determine the purposes and means of processing |
| **Data Processor**  | PxSign processes personal data on your behalf according to your instructions       |
...
PxSign processes personal data necessary to provide document signing services:
...
Where your data is stored depends on how you use PxSign:

<Tabs items={['PxSign Cloud', 'Self-Hosted']}>
<Tab value="PxSign Cloud">
...
Contact PxSign for specific information about sub-processors and data centre locations.

</Tab>
<Tab value="Self-Hosted">

When you self-host PxSign:

- You control all data storage locations
- No data is transmitted to PxSign's infrastructure
...
- Export user and document data from your PxSign account
- Delete user accounts and associated documents
- Contact PxSign support for assistance with cloud-hosted data

## Data Deletion

PxSign supports data deletion to help fulfill erasure requests:
...
Self-hosting PxSign can simplify GDPR compliance:
...
- Contact [support@sign.pixeldesign.io](mailto:support@sign.pixeldesign.io) to request a DPA
- The DPA covers PxSign's obligations as a data processor

</Tab>
<Tab value="Self-Hosted">

No DPA with PxSign is required since no personal data is processed by PxSign.
...
This documentation is provided for informational purposes only and does not constitute legal advice. GDPR compliance depends on your specific circumstances, including how you use PxSign, what data you process, and your organisation's obligations.
...
- [Self-Hosting Guide](/docs/self-hosting) - Deploy PxSign on your own infrastructure
