---
title: Manual Setup
description: Manually set up PxSign on your machine for local development.
---
...
Follow these steps to set up PxSign on your local machine:
...
Fork the [PxSign repository](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/working-with-forks/about-forks) to your GitHub account.
...
Access the PxSign application by visiting `http://localhost:3000` in your web browser.
