...
description: Learn how to set up PxSign for local development.
---

## Overview

There are multiple ways of setting up PxSign for local development. At the moment of writing this documentation, there are 3 ways of running PxSign locally:
...
- [Contributing](/docs/developers/contributing) - Learn how to contribute to PxSign
