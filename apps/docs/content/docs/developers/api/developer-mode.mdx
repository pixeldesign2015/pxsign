...
description: Advanced development tools for debugging field IDs, recipient IDs, coordinates and integrating with the PxSign API.
---

## Overview

Developer mode provides additional tools and features to help you integrate and debug PxSign.
...
https://app.sign.pixeldesign.io/t/<team-url>/documents/<envelope-id>/legacy_editor?devmode=true
```
...
https://app.sign.pixeldesign.io/t/<team-url>/documents/<envelope-id>/edit?step=addFields&devmode=true
```
