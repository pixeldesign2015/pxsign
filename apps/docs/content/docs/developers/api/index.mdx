---
title: API Reference
description: Complete reference for the PxSign REST API.
---
...
<Callout type="warn">
  ...
  For an always up-to-date reference, see the [OpenAPI Reference](https://openapi.sign.pixeldesign.io).
</Callout>

## Base URL

```
https://app.sign.pixeldesign.io/api/v2
```
