...
PxSign offers two types of embedding:
...
<Steps>
<Step>
Navigate to your team's templates in PxSign
...
For example, `https://app.sign.pixeldesign.io/d/-WoSwWVT-fYOERS2MI37k` has the token `-WoSwWVT-fYOERS2MI37k`.
...
| `host`                | `string`   | PxSign instance URL. Defaults to `https://app.sign.pixeldesign.io`. |
