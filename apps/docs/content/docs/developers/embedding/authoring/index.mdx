...
In addition to embedding signing, PxSign supports embedded authoring. It allows your users to create and edit documents, templates, and envelopes without leaving your application.
...
This endpoint requires your PxSign API key. The token has a default expiration of 1 hour.

See the [API documentation](https://openapi.sign.pixeldesign.io/reference#tag/embedding) for full details.
