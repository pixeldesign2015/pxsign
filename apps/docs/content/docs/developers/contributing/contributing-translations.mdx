...
description: Learn how to contribute translations to PxSign and become part of our community.
---
...
msgid "Want to send slick signing links like this one? <0>Check out PxSign.</0>"
msgstr "Möchten Sie auffällige Signatur-Links wie diesen senden? <0>Überprüfen Sie PxSign.</0>"
```
...
Thank you for helping make PxSign more accessible to users around the world!
