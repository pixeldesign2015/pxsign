...
description: The open-source version of PxSign, available under the AGPL-3.0 license. Includes core document signing functionality and can be self-hosted.
---
...
| Action             | Description                                                   |
| ------------------ | ------------------------------------------------------------- |
| **Use**            | Run PxSign for any purpose, including commercial use       |
...
<Accordions type="multiple">
  <Accordion title="Source Code Disclosure">
    If you modify PxSign and make it available over a network, you must:
    ...
    <Callout type="warn">
      ...
      PxSign instance over a network (whether internal or external), you must provide them access to
      the source code.
    </Callout>
  ...
  <Accordion title="License Continuity">
    ...
    - Combined works that incorporate PxSign code are subject to AGPL-3.0
...
The Community Edition includes the core PxSign functionality:
...
<Accordions type="multiple">
  <Accordion title="Discord">
    The PxSign Discord server is the primary community support channel. You can:
...
<Callout type="info">
  Community support is provided on a best-effort basis by volunteers and PxSign team members. For
  guaranteed response times and dedicated support, consider the Enterprise Edition.
</Callout>

## Contributing Back

Contributions to PxSign are welcome and appreciated. You can contribute in several ways:

<Accordions type="multiple">
  <Accordion title="Code Contributions">
    1. Fork the [PxSign repository](https://github.com/documenso/documenso)
