...
Join the PxSign Discord server to:

- Ask questions and get help from the community
- Share feedback and feature requests
- Connect with other PxSign users
...
Paid plans include access to direct support from the PxSign team.
...
- Email support at support@sign.pixeldesign.io
- Account and billing assistance
- Technical guidance for PxSign Cloud usage
...
- Private Discord channel for direct communication with the PxSign team
...
- Guidance on PxSign features and functionality
...
For billing disputes or account issues, email support@sign.pixeldesign.io with your account details.
...
<Steps>
  <Step>
    ...
    Email security@sign.pixeldesign.io.
...
PxSign follows responsible disclosure practices. Security researchers who report valid vulnerabilities responsibly will be acknowledged.

## Contact

| Purpose          | Contact                                                        |
| ---------------- | -------------------------------------------------------------- |
| General support  | support@sign.pixeldesign.io                                          |
| Security issues  | security@sign.pixeldesign.io                                         |
| Enterprise sales | [sales@sign.pixeldesign.io](https://documen.so/enterprise)           |
| Privacy requests | privacy@sign.pixeldesign.io                                          |
...
- [Privacy Policy](/docs/policies/privacy) - How PxSign handles your data
