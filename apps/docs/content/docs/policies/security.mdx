---
title: Security
description: Security practices for PxSign Cloud and self-hosted deployments, along with our vulnerability disclosure process.
---
...
<Accordions type="multiple">
  <Accordion title="Encryption in Transit">
    All data transmitted to and from PxSign is encrypted using TLS 1.2 or higher. This includes:
  ...
  <Accordion title="Application-Level Encryption">
    PxSign encrypts sensitive data at the application level:
...
PxSign operates a responsible disclosure process for security vulnerabilities.

<Accordions type="multiple">
  <Accordion title="Reporting a Vulnerability">
    If you discover a security vulnerability, please report it by emailing:

    **security@sign.pixeldesign.io**
...
When self-hosting PxSign, you are responsible for the security of your deployment. The following recommendations apply:
...
- **Security vulnerabilities**: security@sign.pixeldesign.io
- **General questions**: support@sign.pixeldesign.io
