...
description: Commercial license that removes AGPL-3.0 source code disclosure requirements, allowing organisations to integrate PxSign into proprietary products.
---
...
- **Build proprietary products**: Integrate PxSign into commercial software without releasing source code
...
- **Need to keep modifications private**: Any changes to PxSign source code that you don't want to disclose

<Callout type="info">
  If you run PxSign without modifications, or your modifications are open source under AGPL-3.0,
...
| SaaS product using PxSign API only        | Community Edition  |
| SaaS product with modified PxSign code    | Enterprise Edition |
...
<Accordions type="multiple">
  <Accordion title="License Rights">
    ...
    - **Proprietary integration**: Embed PxSign in closed-source products without licensing conflicts.
    - **Sublicensing options**: Distribute PxSign as part of your product to your customers (terms vary by agreement).
  ...
  <Accordion title="License Setup">
    ...
    2. Access your license key at [license.sign.pixeldesign.io](https://license.sign.pixeldesign.io)
    ...
    4. Restart your PxSign instance
...
<Accordions type="multiple">
  <Accordion title="Grant of License">
    The Enterprise license is a commercial agreement between your organisation and PxSign. Key terms include:

    - **Scope**: License to use, modify, and distribute PxSign as specified in your agreement
    - **Exclusions**: The license does not grant rights to PxSign trademarks beyond what's specified
  ...
  <Accordion title="What the License Does Not Cover">
    ...
    - PxSign Cloud service (separate subscription)
...
| Factor              | Description                         |
| ------------------- | ----------------------------------- |
| **Deployment type** | Self-hosted or PxSign Cloud      |
...
<Steps>
  ...
  <Step>
    ...
    - Email: [sales@sign.pixeldesign.io](https://documen.so/enterprise)
  ...
  <Step>
    ...
    Options for evaluating PxSign before purchase:
  ...
  <Step>
    ...
    3. Deploy using [self-hosting guides](/docs/self-hosting) or access PxSign Cloud
...
<Accordions type="multiple">
  ...
  <Accordion title="Does the Enterprise license include PxSign Cloud?">
