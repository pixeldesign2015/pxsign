...
description: Sign up for PxSign and configure your profile.
---
...
Check your inbox for a verification email and click the confirmation link. The email is sent from `noreply@sign.pixeldesign.io`.
...
<Steps>
  <Step>
    ...
    ![PxSign account security page showing security options](/get-started-images/documenso-account-security-page.webp)
