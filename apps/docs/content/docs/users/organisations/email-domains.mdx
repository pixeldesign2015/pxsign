---
title: Email Domains
description: Learn how to create and manage email domains in PxSign.
---
...
Email Domains allow you to send emails to recipients from your own domain instead of the default PxSign email address.
...
- Access to your PxSign organisation as an admin or manager
...
After adding your domain, PxSign will provide you with the following required DNS records that need to be configured on your domain:
...
Once you've added the DNS records, return to the PxSign email domains settings page and click the "Verify" button.
