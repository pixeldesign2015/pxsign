---
title: Overview
description: Organisations are the top-level entity in PxSign, containing teams, members, and shared settings.
---
...
Organisations are the top-level entity in PxSign's hierarchy. Each organisation can contain multiple teams, and each team can have multiple members.
...
![Create organisation in PxSign dashboard](/organisations/organisations-create.webp)
