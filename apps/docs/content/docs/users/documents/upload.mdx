...
<Callout type="warn">
  PxSign does not support password-protected or encrypted PDF files. Remove encryption before
  uploading.
</Callout>
...
<Steps>
  <Step>
    ...
    Open your [Documents dashboard](https://app.sign.pixeldesign.io/documents).
...
1. **Processing**: PxSign validates the PDF and extracts page information
