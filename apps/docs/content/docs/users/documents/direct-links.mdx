...
- **Create one automatically**: PxSign creates a new "Direct Link Recipient" for you
...
```
https://app.sign.pixeldesign.io/d/<unique-token>
```
...
If the recipient has a PxSign account with the email they entered, the document also appears in their Documents dashboard.
...
You can showcase templates with direct links on your public PxSign profile:
...
![PxSign profile with direct links](/direct-links/documenso-profile.webp)
...
```html
<a href="https://app.sign.pixeldesign.io/d/your-token">Sign our agreement</a>
```
