...
export function meta({ params: { slug } }: Route.MetaArgs) {
  ...
  return [
    { title: 'PxSign - Share' },
    { description: 'I just signed a document in style with PxSign!' },
    {
      property: 'og:title',
      content: 'PxSign - Join the open source signing revolution',
    },
    {
      property: 'og:description',
      content: 'I just signed with PxSign!',
    },
    {
      property: 'og:type',
      content: 'website',
...
export const loader = async ({ request, params: { slug } }: Route.LoaderArgs) => {
  ...
  // Is hardcoded because this whole meta is hardcoded anyway for PxSign.
  throw redirect('https://sign.pixeldesign.io');
};
