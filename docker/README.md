# Docker Setup for PxSign

The following guide will walk you through setting up PxSign using Docker. You can choose between a production setup using Docker Compose or a standalone container.
...
This setup includes a PostgreSQL database and the PxSign application. You will need to provide your own SMTP details via environment variables.

1. Download the Docker Compose file from the PxSign repository: [compose.yml](https://raw.githubusercontent.com/documenso/documenso/release/docker/production/compose.yml)
...
This will start the PostgreSQL database and the PxSign application containers.

6. Access the PxSign application by visiting `http://localhost:3000` in your web browser.

## Option 2: Standalone Docker Container

If you prefer to host the PxSign application on your container provider of choice, you can use the pre-built Docker image from DockerHub or GitHub's Package Registry. Note that you will need to provide your own database and SMTP host.

1. Pull the PxSign Docker image:
...
3. Access the PxSign application by visiting the URL you provided in the `NEXT_PUBLIC_WEBAPP_URL` environment variable in your web browser.

## Success

You have now successfully set up PxSign using Docker. You can start organizing and managing your documents efficiently.
...
Check the status of your PxSign instance:
...
If you encounter any issues or have further questions, please refer to the official PxSign documentation or seek assistance from the community.

## Advanced Configuration

The environment variables listed above are a subset of those that are available for configuring PxSign. For a complete list of environment variables and their descriptions, refer to the table below:

Here's a markdown table documenting all the provided environment variables:

| Variable                                                       | Description                                                                                         |
| -------------------------------------------------------------- | --------------------------------------------------------------------------------------------------- |
| `PORT`                                                         | The port to run the PxSign application on, defaults to `3000`.                                   |
